...
init -1 python hide:
    ...
    config.window_title = u"Persona Special Love Edition"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Persona Special Love Edition"
    config.version = "0.0"
...
python early:
    config.save_directory = "Persona Special Love Edition-1457931475"
